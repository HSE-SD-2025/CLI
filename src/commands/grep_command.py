...
class GrepCommand(CommandInterface):
    ...
    def __compile_pattern(
        self, pattern: str, word_regexp: bool, ignore_case: bool
    ) -> re.Pattern:
    ...
    def __process_file(
        self, file_name: str, pattern: re.Pattern, after_context: int
    ) -> List[Tuple[int, str]]:
    ...
    def execute(self, args: List[str]) -> int:
        ...
        pattern = self.__compile_pattern(
            parsed_args.pattern, parsed_args.word_regexp, parsed_args.ignore_case
        )
